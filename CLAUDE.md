...
- CI on push to `main`/`dev` and release builds must pass error-level Scenario lint plus the 20-test headless quality gate before Windows, Linux, or Android export jobs run
